...
async def read_root():
    ...
    return "MobileNet모델을 사용하는 API를 만들업 봅시다."

@app.get('/sample')
async def sample_prediction():
    result = await mobilenet_prediction_model.prediction_model()
...
if __name__ == "__main__":
    uvicorn.run("server_fastapi_mobilenet:app",
