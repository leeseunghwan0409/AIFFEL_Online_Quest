...
# 예측 모듈 가져오기
import DenseNet_prediction_model
...
async def read_root():
    ...
    return "Jellyfish모델에서 사용했던 DenseNet을 사용하는 API를 만들어 봅시다."

@app.get('/sample')
async def sample_prediction():
    result = await DenseNet_prediction_model.prediction_model()
...
if __name__ == "__main__":
    uvicorn.run("server_fastapi_jellyfish_DenseNet:app",
